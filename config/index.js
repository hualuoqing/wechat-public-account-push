export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxc7288d5be45e6eee",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "7bb11dbe97e89a2a6f340122e3d0c56b",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "875k2nNxROko1iBU4BQ6KChb6x_VgcRKSu2SR3SEsNs",
      // 所在省份
      province: "北京",
      // 所在城市
      city: "北京",
      ...
      openUrl: "www.已经是世界尽头啦！.(╯▔皿▔)╯.com",
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {"type": "*生日", "name": "主人", "year": "2001", "date": "08-12"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2001-08-12"},
        // 结婚纪念日
        {"keyword": "marry_day", date: "2024-02-10"},
        // 退伍日
        {"keyword": "ex_day", date: "2022-12-28"},
      ]
    },
    {
      name: ": L",
